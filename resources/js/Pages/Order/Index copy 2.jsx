  ...
  return (
    ...
    >
      <Head title="الطلبات" />
       {/* Approve Modal */}
       {showApproveModal && (
        <Modal title="تأكيد الموافقة" onClose={() => setShowApproveModal(false)}>
          <p>هل أنت متأكد أنك تريد الموافقة على هذا الطلب؟</p>
          <div className="flex justify-end mt-4">
            <button onClick={handleApprove} className="btn btn-primary mx-2">موافق</button>
            <button onClick={() => setShowApproveModal(false)} className="btn btn-secondary">إلغاء</button>
          </div>
        </Modal>
      )}
      ...
      {/* Reject Modal */}
      {showRejectModal && (
        <Modal title="تأكيد الرفض" onClose={() => setShowRejectModal(false)}>
          <p>هل أنت متأكد أنك تريد رفض هذا الطلب؟</p>
          <TextInput
            className="mt-4"
          ...
          />
          <div className="flex justify-end mt-4">
            <button onClick={handleReject} className="btn btn-primary mx-2">موافق</button>
            <button onClick={() => setShowRejectModal(false)} className="btn btn-secondary">إلغاء</button>
          </div>
        </Modal>
      )}
                      ...
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={order.id}>
                        ...
                        {order.status === 'in_progress' && (
                          <td className="px-3 py-2 text-nowrap">
                            <button onClick={() => openApproveModal(order)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">موافق</button>
                            <button onClick={() => openRejectModal(order)} className="font-medium text-red-600 dark:text-red-500 hover:underline mx-1">رفض</button>
                          </td>
                        )}
                      </tr>
                    ))}
