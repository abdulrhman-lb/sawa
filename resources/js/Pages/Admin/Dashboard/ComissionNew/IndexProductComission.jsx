                  ...
                  <tbody className="text-center">
                    {comissionData.map((user, index) => (
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={user.id}>
                        ...
                        <td className="px-1 py-2 text-nowrap">{user.product}</td>
                        <td className="px-1 py-2">
                          <div className="px-1 py-2 text-right">
                            {user.services.map((product) => (
                              <span className="min-w-[100px] inline-block text-center bg-indigo-800 text-indigo-100 text-lg font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-indigo-900 dark:text-indigo-300 my-1">
                                {product}
                              </span>
                            ))}
                          </div>
