...
export default function index({ auth, datakinds, queryParams = null, success, message, initialNotifications }) {
      ...
      header={
        <div className="flex justify-between items-center">
          <ScrollBar message={message}>
            ...
            <AddButton onClick={e => addDataKind()}>إضافة</AddButton>
          </ScrollBar>
        </div>
      }
    >
                    ...
                    {datakinds.data.map((datakind, index) => (
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={datakind.id}>
                        ...
                        <td className="px-3 py-2 text-nowrap">
                          <PrimaryButton onClick={e => editDataKind(datakind)}>تعديل</PrimaryButton>
                          <DeleteButton onClick={e => deleteDataKind(datakind)}>حذف</DeleteButton>
                        </td>
                      </tr>
                    ))}
                  </tbody>
